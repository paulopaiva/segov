...
$scope.pegaCurso = function(){
var valores = {
  parametros:'pegaCurso',
  pagina:0
}
    $http({
          method:'POST',
...
$scope.gravaUsuario = function(usuario){
 ...
 //  $scope.usuarioForm.$setPristine();
    ...
    var valores = {
      ...
      senha:usuario.senha,
      idindicacao:usuario.idindicacao,
 ...
 //          console.log(data);
           ...
           if (data[0].idusuario){
            ...
            localStorage.setItem('idindicacao', usuario.idindicacao);
...
$scope.usuario = function() {
 ...
 $scope.usuario.idindicacao = localStorage.getItem('idindicacao');
